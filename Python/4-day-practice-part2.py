...
fourthInt = ourYear % 10
thirdInt = (ourYear % 100) // 10

if fourthInt == 0 and thirdInt == 0:
    print("YES")
else:
    print("NO")
...
# Заданы две клетки шахматной доски. Напишите программу, которая определяет, имеют ли указанные клетки один 
# цвет или нет. Если они покрашены в один цвет, то выведите слово «YES», а если в разные цвета, то «NO».

a_1 = int(input("Клетка №1. Введите номер столбца: "))
a_2 = int(input("Клетка №1. Введите номер строчки: "))

b_1 = int(input("Клетка №2. Введите номер столбца: "))
b_2 = int(input("Клетка №2. Введите номер строчки: "))


# четная четная
if a_1 % 2 == 0 and b_1 % 2 == 0:
    if (a_2 % 2 == 0 and b_2 % 2 == 0) or (a_2 % 2 != 0 and b_2 % 2 != 0):
        print("YES")
    else:
        print("NO")

# четная нечетная
elif a_1 % 2 == 0 and b_1 % 2 != 0:
    if (a_2 % 2 == 0 and b_2 % 2 != 0) or (a_2 % 2 != 0 and b_2 % 2 == 0):
        print("YES")
    else:
        print("NO")
...
# Проверяем, может ли слон попасть с первой клетки на вторую
...
# Проверяем, может ли конь попасть с первой клетки на вторую
