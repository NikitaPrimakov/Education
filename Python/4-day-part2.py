#####################################################
## День 4. Тема урока: условный оператор            #
#####################################################
...
# В данном случае использовать каскадный условный оператор
...
# стальная часть конструкции игнорируется. Однако если условие1 является ложным, то программа перескакивает непосредственно 
# к следующему выражению elif и проверяет условие2. Если оно истинное, то исполняется блок кода, который следует сразу 
...
# е останется выражений elif. Если ни одно условие не является истинным, то исполняется блок кода после выражения else.
